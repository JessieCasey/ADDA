package com.adda.advert.photo.service.parameters;
...
public class UploadParameters {
    ...
    public UploadParameters(String apiKey, String imageBase64, String imageName, ExpirationTime expirationTime) {
        this.apiKey = apiKey;
